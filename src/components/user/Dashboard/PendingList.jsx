...
import { UserPendingApplyPostList } from "../../../services/userApi";
function PendingList() {
  ...
  const handleSearch = async (searchTerm) => {
    ...
    try {
      const res = await UserPendingApplyPostList(UserInfo.userinfoid, searchTerm);
      setPosts(res.data);
  ...
  async function GetRequsts() {
    try {
      const res = await UserPendingApplyPostList(UserInfo.userinfoid, Search);
      setPosts(res.data);
      setSearcheddata(res.data.results);
    } catch (error) {
      console.log(error);
