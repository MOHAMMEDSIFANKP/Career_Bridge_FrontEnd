...
function AllapplyedList() {
  ...
  const handleSearch = async (searchTerm) => {
    ...
    try {
      const res = await UserApplyPostList(UserInfo.userinfoid, searchTerm);
      setPosts(res.data);
  ...
  async function GetRequsts() {
    try {
      const res = await UserApplyPostList(UserInfo.userinfoid, Search);
      setPosts(res.data);
      setSearcheddata(res.data.results);
    } catch (error) {
      console.log(error);
