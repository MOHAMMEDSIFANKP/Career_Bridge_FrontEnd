...
import { ListofcompanypostBlocked } from "../../../../../services/companyApi";
...
function BlockedPosts() {
  ...
  const handleSearch = async (searchTerm) => {
    ...
    try {
      const res = await ListofcompanypostBlocked(
    ...
    <>
      {!view.view ? (
        <>
          ...
          {Posts.count === 0 ? (
            <div className="bg-purple-50 h-[26rem] mt-4 mx-5 rounded-xl flex justify-center items-center">
              <p className="font-bold rounded-2xl border flex justify-center items-center text-gray-600 text-2xl">
                <span>Blocked Post is empty</span>
              </p>
            </div>
          ) : null}
        </>
