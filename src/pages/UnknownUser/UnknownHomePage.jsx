...
function UnknownHomePage() {
  ...
  return (
    <div className="grid grid-rows-[5rem,1fr]">
      <div className="border grid grid-cols-[18rem,1fr] shadow">
        <div className="flex justify-center items-center">
          <p className="text-purple-400 font-bold text-3xl">Career Bridge</p>
        </div>
      ...
      <ToastContainer />
      {loading && <Loader />}
          <div className=" me-10 h-[50rem] scrollbar-thumb-amber-600 overflow-y-auto">
