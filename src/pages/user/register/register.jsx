    ...
    return (
        <div className="h-screen flex flex-col items-start">
            ...
            <div className="bg-white rounded-2xl sm:w-10/12 md:w-6/12 lg:w-4/12 xl:w-4/12 border border-purple-400 mx-auto mt-16 grid grid-row-8 gap-2">
                <div>
                    <h3 className="text-2xl font-medium my-5 text-center">Sign up to find work you love</h3>
                </div>
                    <div>
                    ...
                    <div className="mx-10 flex">
                     <hr className="m-5 w-40 border-1 border-purple-400"/>
                      <p>or</p>
                     <hr className="m-5 w-40 border-1 border-purple-400"/>
                    </div>
                    <div className="flex mx-10 rounded-3xl mt-1 py-1 my-10 bg-purple-500 items-center">
                    ...
                    <div className="mx-10 flex">
                     <hr className="m-5 w-20 border-1 border-purple-400"/>
                      <p className="text-xs">Already have an account? <span className="text-purple-400">Log in</span></p>
                     <hr className="m-5 w-20 border-1 border-purple-400"/>
                    </div>
            </div>
        </div>
